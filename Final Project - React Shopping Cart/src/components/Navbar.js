...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between h-20 max-w-6xl mx-auto">
      ...
      <div className="flex items-center space-x-6 mr-5 text-gray-700 font-semibold">
        <Link to="/">
          <li className="cursor-pointer hover:text-purple-500 transition duration-300 ease-in">HOME</li>
        </Link>
        <Link to="/cart">
